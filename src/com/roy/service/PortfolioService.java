...
import com.roy.exceptions.IllegalQuantityException;
import com.roy.exceptions.PortfolioFullException;
import com.roy.exceptions.StockAlreadyExistsException;
import com.roy.exceptions.StockNotExistsException;
import com.roy.exceptions.SymbolNotFoundInNasdaq;
...
public class PortfolioService {
	...
	public void addStock(String symbol) throws StockAlreadyExistsException, PortfolioFullException, StockNotExistsException, SymbolNotFoundInNasdaq {
		...
		if(stock != null) {
			...
			datastoreService.saveStock(portfolio.getStocksStatus()[portfolio.findStock(symbol)]);
			
			flush();
		}
	}
	
	public void buyStock(String symbol, int quantity) throws BalanceException, StockNotExistsException, StockNotExistsException, StockAlreadyExistsException, PortfolioFullException {
